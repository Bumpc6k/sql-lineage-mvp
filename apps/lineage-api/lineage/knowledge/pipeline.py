...
from lineage.knowledge.comments import parse_sql_comments
from lineage.knowledge.extractor import ExtractionResult, KnowledgeExtractor
from lineage.knowledge.store import KnowledgeStore, default_db_path
from lineage.knowledge.textutil import Glossary
...
def build_knowledge_base(
    ...
    with KnowledgeStore(store_path) as store:
        ...
        if doc_path:
            from lineage.knowledge.markdown import export_markdown
